...
public class Patterns {
    public final static String intRegex = "int[\\s]+[a-zA-Z_][a-zA-Z_0-9]*[\\s]+=[\\s]+[1-9][0_9]{0,7}";
    public final static String negativeIntRegex = "int[\\s]+[a-zA-Z_][a-zA-Z_0-9]*[\\s]+=[\\s]+-[1-9][0_9]{0,7}";
    public final static String floatRegex = "float[\\s]+[a-zA-Z_][a-zA-Z_0-9]*[\\s]+=[\\s]+[0-9]+.[0_9]{1,10}";
    public final static String negativeFloatRegex = "float[\\s]+[a-zA-Z_][a-zA-Z_0-9]*[\\s]+=[\\s]+-[0-9]+.[0_9]{1,10}";
    public final static String floatRegexWithoutPoint = "float[\\s]+[a-zA-Z_][a-zA-Z_0-9]*[\\s]+=[\\s]+[0-9]+";
    public final static String negativeFloatRegexWithoutPoint = "float[\\s]+[a-zA-Z_][a-zA-Z_0-9]*[\\s]+=[\\s]+-[0-9]+";
